...
app.config["MAIL_DEFAULT_SENDER"] = "L.M.S <abir221001020057@technoindiaeducation.com>"
mail = Mail(app)

def send_welcome_email(name, email, phone, duration, username, password, role):
    try:
        msg = Message(
            subject="Your L.M.S Membership Details",
            recipients=[email],
        ...
        <div style="font-family: Arial, sans-serif; background:#020617; padding:30px; color:#e5e7eb;">
          ...
          <div style="text-align:center;">
            <img src="cid:L.M.S_logo" width="140">
            <p style="font-size:12px; color:#94a3b8;">
              L.M.S Library Management System<br>
        ...
        with app.open_resource("static/mail/L.M.S_logo.png") as fp:
            msg.attach(
                filename="images.jpg",
                content_type="image/jpg",
                data=fp.read(),
                disposition="inline",
                headers={"Content-ID": "<L.M.S_logo>"}
            )
